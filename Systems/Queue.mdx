...
The queue system comes with a singular queue along with a leave part and a queue gui with the spot the player is in and a leave button. 

## Setup

## Creating more queues

To create a queue, just clone the existing clone titled `queue1` and change the clone's name. You can move it in any direction you please.
