...
🔄 Automatic Line Positioning: Players are smoothly moved behind the person in front of them when joining.
🚪 Easy Entry & Exit: Players join by walking into a defined queue part, and can leave at any time with a clear on-screen "Leave" button.
📊 Live Position Display: A clean, responsive GUI shows each player their current position in line.
⚙️ Module + Ready-Made Setup: Comes with a drag-and-drop prebuilt queue part and a flexible module for custom integration.
🧩 Developer-Friendly: Fully modular and designed to plug into your existing systems with minimal setup.

See more information and documentation at https://player.mintlify.app/Systems/Queue."
icon: "users"
---
<Info>
